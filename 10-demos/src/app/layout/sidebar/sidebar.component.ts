...
const sidebarContent = [
  ...
  },
  {
    ...
    links: [
      ...
      {url: '/forms/custom-form-control', title: '02.20 Custom Form Control'},
      {url: '/forms/composition-passing', title: '02.30 Composition Passing From Group'},
      {url: '/forms/composition-custom', title: '02.31 Composition Custom Controls'},
    ]
  },
  {
    title: 'Backend',
